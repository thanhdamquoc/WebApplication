        ...
        <div class="col">
            <div align="right">
                <form action="/products" method="get">
                    <input placeholder="Search" type="text" name="q" class="btn" style="border: 1px solid black; text-align: left">
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${requestScope['products']}" var="product">
                    <tr>
                        ...
                        <td>
                            <a href="/products?action=edit&id=${product.id}" class="btn btn-primary">Edit</a> | <a href="/products?action=remove&id=${product.id}" class="btn btn-danger">Remove</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
